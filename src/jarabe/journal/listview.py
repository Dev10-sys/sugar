...
class TreeView(Gtk.TreeView):
    ...
    def do_size_request(self, requisition):
        ...
        try:
            # Let's pass requisition to Gtk.TreeView if it exists, otherwise just ignore.
            if hasattr(Gtk.TreeView, 'do_size_request'):
...
class BaseListView(Gtk.Box):
    ...
    def __drag_prepare_cb(self, drag_source, x, y):
        ...
        value.set_string("journal-object-id")
    ...
    def _show_message(self, message, show_clear_query=False):
        ...
        css_provider.load_from_data(b"box.bg-white { background-color: white; }")
        context = background_box.get_style_context()
