...
class ActivityChooser(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.set_size_request(
            (screen_height - style.GRID_CELL_SIZE * 3) * 3 // 4,
            (screen_height - style.GRID_CELL_SIZE * 2) * 2 // 3)
        ...
        # Add key controller to search entry too
        search_key_controller = Gtk.EventControllerKey()
        search_key_controller.connect('key-pressed',
                                      self.__search_key_pressed_cb)
        ...
        # GTK4: Use activate_on_single_click
    ...
    def __search_key_pressed_cb(self, controller, keyval, keycode, state):
