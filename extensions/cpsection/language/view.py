...
def set_palette_list(palette_list):
    ...
    # Actually wait, `get_preferred_size` is GTK3. We can just skip calculation if we want.
    # Since we can't easily rely on `menu_item` measure without parent, let's approximate or just set reasonable size.
