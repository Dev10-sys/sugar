...
class ModemConfiguration(SectionView):
    def __init__(self, model, alerts=None):
        ...
        self._upper_box.set_visible(True)
        ...
        self._number_entry.set_visible(True)
        ...
        self._apn_entry.set_visible(True)
        ...
        self._pin_entry.set_visible(True)
